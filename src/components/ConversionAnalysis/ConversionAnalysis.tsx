...
const ConversionAnalysis = () => {
  ...
  const { newFunction: _getLatestLogs } = useAuthMidd<{ conversionLogs: Log; analysisLogs: Log }>(
    getLatestLogs
  );
    ...
    try {
      ...
      toast(
        <div>
          ...
          <Text>
            If you can see the details go to: <a href='/admin/results'>See reports</a>
          </Text>
        </div>,
  ...
  return (
    <div className={classes['container']}>
      <Tabs
        onTabChange={(val: string) => startTransition(() => setActiveTab(val))}
        variant='outline'
        radius='md'
        defaultValue='conversion'
      >
        <Tabs.List>
          <Tabs.Tab value='conversion' icon={<IconTransform />}>
            Conversion
          </Tabs.Tab>
          <Tabs.Tab value='analysis' icon={<IconDeviceDesktopAnalytics />}>
            Analysis{' '}
          </Tabs.Tab>
        </Tabs.List>
        ...
        <Tabs.Panel value='conversion' pt='xs'>
          <RenderLogs
            ...
            dataLogs={logs?.conversionLogs?.dataLogs || []}
        ...
        <Tabs.Panel value='analysis' pt='xs'>
          <RenderLogs
            title='Analysis Logs'
            dataLogs={logs?.analysisLogs?.dataLogs || []}
      ...
      {isLoading && (
        <Group className={classes['loader']} position='center'>
